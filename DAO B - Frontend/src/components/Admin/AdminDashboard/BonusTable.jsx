...
export default function BonusTable({ users, filterNew, voting, finished, declined }) {
    ...
    // if (filterNew) {
    //     people = people.filter(person => person.newRequest);
    // }

    // if (voting) {
    //     people = people.filter(person => person.voting);
    // }

    // if (finished) {
    //     people = people.filter(person => person.finished);
    // }

    // if (declined) {
    //     people = people.filter(person => person.declined);
    // }
